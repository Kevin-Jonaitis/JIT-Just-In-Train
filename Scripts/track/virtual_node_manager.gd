...
func setup_interjunction_virtual_nodes():
	...
	var start_entry_node = VirtualNode.new_virtual_node(track.start_junction, track, true)
	var start_exit_node = VirtualNode.new_virtual_node(track.start_junction, track, false)
	var end_entry_node = VirtualNode.new_virtual_node(track.end_junction, track, true)
	var end_exit_node = VirtualNode.new_virtual_node(track.end_junction, track, false)
...
func add_temp_virtual_node(point_index: int, train: Train) -> Array[VirtualNode]:
	...
	var distance_to_end = track.dubins_path.shortest_path.length - distance_to_start
