...
func setup_interjunction_virtual_nodes() -> void:
	...
	var start_exit_node: VirtualNode = track.start_junction.get_junction_node(track, true, false)
	var start_entry_node: VirtualNode = track.start_junction.get_junction_node(track, true, true)
	var end_entry_node: VirtualNode = track.end_junction.get_junction_node(track, false, true)
	var end_exit_node: VirtualNode = track.end_junction.get_junction_node(track, false, false)
