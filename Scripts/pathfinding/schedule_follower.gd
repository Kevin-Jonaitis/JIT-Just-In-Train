...
# var car_progresses: Array[CarProgress] = []
...
func update_train_position(delta: float) -> void:
	...
	train.set_position_and_rotation(get_car_progresses()[0].front_boogie.position, get_car_progresses()[0].front_boogie.rotation) # Should we change this?
